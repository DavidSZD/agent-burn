...
gen-models-dev-pricing:
    snapshots="$(nix build .#models-dev-pricing --no-link --print-out-paths)" && cp "$snapshots/models-dev-pricing.json" rust/crates/agent-burn/src/models-dev-pricing.json && cp "$snapshots/codex-auto-review-fallbacks.json" rust/crates/agent-burn/src/adapter/codex/codex-auto-review-fallbacks.json
    chmod u+w rust/crates/agent-burn/src/models-dev-pricing.json
    chmod u+w rust/crates/agent-burn/src/adapter/codex/codex-auto-review-fallbacks.json
    nix fmt rust/crates/agent-burn/src/models-dev-pricing.json
    nix fmt rust/crates/agent-burn/src/adapter/codex/codex-auto-review-fallbacks.json
